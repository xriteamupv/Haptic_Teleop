...
class TrajectoryClient:
    ...
    def send_cartesian_trajectory(self):
        ...
        pose_list = [
            geometry_msgs.Pose(
                geometry_msgs.Vector3(-0.135, 0.647, 0.550), geometry_msgs.Quaternion(0.9983018, -0.0512478, 0.0101965, -0.0257526 )
            ),
        ]
        #geometry_msgs.Vector3(-0.135, 0.647, 0.199), geometry_msgs.Quaternion(0.9983018, -0.0512478, 0.0101965, -0.0257526 )
            ############
        #    geometry_msgs.Pose(
        #        geometry_msgs.Vector3(0.1, 0.4, 0.6), geometry_msgs.Quaternion(0, 0, 1, 0)
        #    ),
        #    geometry_msgs.Pose(
        #        geometry_msgs.Vector3(-0.3, 0.4, 0.6), geometry_msgs.Quaternion(0, 0, 1, 0)
        #    ),
        #    geometry_msgs.Pose(
        #        geometry_msgs.Vector3(-0.3, 0.4, 0.4), geometry_msgs.Quaternion(0, 0, 0, 1)
        #    ),
        #    geometry_msgs.Pose(
        #        geometry_msgs.Vector3(0.1, 0.4, 0.4), geometry_msgs.Quaternion(0, 0, 0, 1)
        #    ),
        #]
        ######### ORIG
        #geometry_msgs.Pose(
