...
class HapticMapper:
    ...
    @staticmethod
    def weighted_interpolation(width_var, force, limitator, weights, non_linear_scaling_factor=1.5):
        """
        ...
        vibration_intensity = weights[0] * width_mapped + weights[1] * force_mapped
    ...
    def dynamically_weighted_interpolation(width_var, force, limitator, thresholds, non_linear_scaling_factor=1.5):
        """
        ...
        weight_width, weight_force = HapticMapper.dynamic_weights(width_var, force, thresholds)
