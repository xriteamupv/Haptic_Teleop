...
class Classifier:
    ...
    def __init__(self):
        ...
        with open('/home/ros-iteam/catkin_ws/src/haptic_ur5e/src/model/keypoint_classifier/keypoint_classifier_label.csv',
                encoding='utf-8-sig') as f:
            self.keypoint_classifier_labels = csv.reader(f)
            self.keypoint_classifier_labels = [
                row[0] for row in self.keypoint_classifier_labels
            ]
        with open('/home/ros-iteam/catkin_ws/src/haptic_ur5e/src/model/point_history_classifier/point_history_classifier_label.csv',
                encoding='utf-8-sig') as f:
